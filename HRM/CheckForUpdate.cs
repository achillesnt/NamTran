...
namespace HRM
{
    ...
    {
        private static string xmlFileUrl = "http://update.seqvn.local/hrm/update_example.xml";

        private readonly frmLogin mainApp;
        ...
        public CheckForUpdate(frmLogin mainApp)
        {
        ...
        private void CheckForUpdateFunction()
        {
            ...
            try
            {
                ...
                if (StopWorkerThread()) return;
                if (filename.Length == 0) filename = "installer.zip";
